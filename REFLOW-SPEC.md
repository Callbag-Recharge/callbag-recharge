...
>
> **"re"** — reactive, review, reusable.

This spec defines the protocol, primitives, and container that both `reflow-ts` and `reflow-py`
implement. Language-specific ergonomics (syntax, concurrency model, type encoding) are
implementation choices — the spec defines **behavior**.
