...
**Tier 2:** debounce, throttle, delay, bufferTime, bufferCount, timeout, sample, audit, switchMap, concatMap, exhaustMap, rescue, repeat, reduce, toArray, groupBy, race, window, windowCount, windowTime
