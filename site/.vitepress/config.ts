		...
		vite: {
			resolve: {
				alias: {
					...
					"callbag-recharge/ai/conversationThread": resolve(root, "src/ai/conversationThread"),
			...
			sidebar: {
				...
				"/api/": [
					...
					},
					{
						...
						collapsed: true,
						items: [
							{ text: "chatStream()", link: "/api/chatStream" },
							{ text: "conversationThread()", link: "/api/conversationThread" },
							{
								text: "agentLoop()",
