...
- [Two-Phase Push: DIRTY First, Values Second](./08-two-phase-push-dirty-first-values-second) — pending counts and the value wave
- [Push Dirty, Pull Values](./04-push-dirty-pull-values-our-first-diamond-solution) — where pull-time recompute was the default
