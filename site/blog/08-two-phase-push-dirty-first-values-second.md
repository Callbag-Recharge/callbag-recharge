...
description: "Phase 1 marks the graph; phase 2 delivers values through the same callbag sinks. Here's how pending counts, diamonds, and batching compose — without a second data plane."
date: 2026-03-24
author: David Chen
outline: deep
---
...
- [From Pull-Phase to Push-Phase Memoization](./09-from-pull-phase-to-push-phase-memoization) — caching, `equals`, and skipping downstream work
...
*Next in Arc 3: [From Pull-Phase to Push-Phase Memoization](./09-from-pull-phase-to-push-phase-memoization).*
